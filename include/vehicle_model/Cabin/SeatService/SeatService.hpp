#ifndef VMDL_VEHICLE_CABIN_SEATSERVICE_H
#define VMDL_VEHICLE_CABIN_SEATSERVICE_H
...
public:
   ...
   *      Internal - A seat service internal error happened - see error message for details
   */
  AsyncResultPtr_t<VoidResult> moveComponent(const SeatLocation& seatLocation, Component component,
                                             int position);
...
#endif // VMDL_VEHICLE_CABIN_SEATSERVICE_H
